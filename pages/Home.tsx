    ...
    <div className="relative">
      ...
      <section className="min-h-screen flex flex-col items-center justify-center px-6 relative overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-5xl mx-auto text-center space-y-12">
          ...
          <h1 className="text-7xl md:text-[11rem] font-serif font-bold text-white leading-none tracking-tighter">
            Star <span className="text-gold italic">Talks</span>
          </h1>
          
          <p className="text-2xl md:text-4xl text-slate-300 max-w-4xl mx-auto font-light italic leading-relaxed pt-4">
            "Talk to your <span className="text-white font-normal underline decoration-gold/40 underline-offset-[12px]">Ownself</span>, to better know yourself, ultimately better know the whole universe."
          </p>
        ...
        <div className="absolute bottom-12 left-1/2 -translate-x-1/2 flex flex-col items-center gap-4 opacity-20">
          <span className="text-[10px] tracking-[0.4em] uppercase font-bold text-white">Scroll to Explore</span>
          <div className="w-[1px] h-16 bg-gradient-to-b from-gold to-transparent"></div>
        </div>
      </section>

      {/* Broad Perspective: The Universal Map */}
      <section className="py-40 px-6 border-y border-white/5 bg-[#05050a]/80 backdrop-blur-sm relative z-10">
        <div className="max-w-5xl mx-auto space-y-32">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-8">
              <h2 className="text-4xl md:text-6xl font-serif text-white leading-tight italic">The Intelligence of <span className="text-gold">Correspondence</span></h2>
            ...
            <div className="p-12 border border-white/5 bg-white/5 rounded-[4rem] flex items-center justify-center text-center">
               <div className="space-y-6">
                 ...
                 <p className="text-2xl font-serif text-slate-300 italic">"The stars impel, they do not compel. They are the clockwork of the soul."</p>
               </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-40 px-6 bg-[#05050a] relative z-10">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24 space-y-6">
            <h2 className="text-5xl md:text-7xl font-serif text-white">Universal <span className="text-gold italic">Architectures</span></h2>
            <p className="text-slate-500 uppercase tracking-[0.5em] text-xs">Four pillars of celestial wisdom adopted by humanity</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-white/5 border border-white/5">
            {/* Western Astrology */}
            <div className="p-12 md:p-20 bg-[#05050a] space-y-8 hover:bg-white/[0.02] transition-colors group">
              <div className="flex justify-between items-start">
                <h3 className="text-3xl font-serif text-white group-hover:text-gold transition-colors">Western Tropical</h3>
              ...
              <div className="pt-4 border-t border-white/5 text-[10px] text-slate-500 uppercase tracking-widest font-bold italic">
            ...
            <div className="p-12 md:p-20 bg-[#05050a] space-y-8 hover:bg-white/[0.02] transition-colors group">
              <div className="flex justify-between items-start">
                <h3 className="text-3xl font-serif text-white group-hover:text-gold transition-colors">Vedic Sidereal</h3>
            ...
            <div className="p-12 md:p-20 bg-[#05050a] space-y-8 hover:bg-white/[0.02] transition-colors group">
              <div className="flex justify-between items-start">
                <h3 className="text-3xl font-serif text-white group-hover:text-gold transition-colors">Chinese BaZi</h3>
            ...
            <div className="p-12 md:p-20 bg-[#05050a] space-y-8 hover:bg-white/[0.02] transition-colors group">
              <div className="flex justify-between items-start">
                <h3 className="text-3xl font-serif text-white group-hover:text-gold transition-colors">Hellenistic / Ancient</h3>
      ...
      <section className="py-40 px-6 bg-[#05050a]/40 backdrop-blur-sm relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-12">
          <h2 className="text-4xl md:text-6xl font-serif text-white italic">Why We Look to the <span className="text-gold">Spheres</span></h2>
